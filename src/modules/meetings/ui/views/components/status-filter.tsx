...
const STATUS_OPTIONS = [
    { id: "upcoming", label: "Upcoming", icon: ClockArrowUpIcon, color: "text-blue-500" },
    { id: "active", label: "Active", icon: VideoIcon, color: "text-green-500" },
    { id: "completed", label: "Completed", icon: CircleCheckIcon, color: "text-gray-500" },
    { id: "processing", label: "Processing", icon: LoaderIcon, animate: true, color: "text-yellow-500" },
    { id: "cancelled", label: "Cancelled", icon: CircleIcon, color: "text-red-500" },
];
