...
const MeetingIdView = ({meetingId, onSuccess}: Props) => {
    ...
    const [ConfirmDialog, confirmRemove] = useConfirm(
        "Delete meeting?", "This action will delete the record of this meeting."
    )
  ...
  return (
    ...
    <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-4">
        ...
        {isActive && (
          <ActiveState onJoin={handleJoinCall} /> 
        )}
        
        {isUpcoming && (
          <UpcomingState onStart={handleJoinCall} /> 
        )}
        
        {isCompleted && (
          <CompletedState onViewSummary={handleViewSummary} /> 
        )}
